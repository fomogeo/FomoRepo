...
export default async function DealsPage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#071828' }}>
      ...
      <section className="py-16 px-4" style={{ background: 'linear-gradient(135deg, #0A1929 0%, #071828 100%)' }}>
        <div className="container mx-auto text-center">
          ...
          <p className="text-sm max-w-3xl mx-auto mb-8" style={{ color: '#7EB8D8' }}>
            ...
            we analyze price history, check customer reviews, verify availability, and ensure genuine discounts.
          </p>

          {/* Stats */}
          <div className="flex flex-wrap justify-center gap-8 mt-8">
            <div className="text-center">
              <div className="text-4xl font-bold mb-2" style={{ color: '#FFB300' }}>{products.length}+</div>
              <div className="text-sm" style={{ color: '#7EB8D8' }}>Active Deals</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold mb-2" style={{ color: '#00D4C8' }}>30+</div>
              <div className="text-sm" style={{ color: '#7EB8D8' }}>Categories</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold mb-2" style={{ color: '#00C853' }}>100%</div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
            <div>
              <h2 className="text-2xl font-bold mb-2" style={{ color: '#E8F4FD' }}>All Verified Products</h2>
              <p className="text-sm" style={{ color: '#7EB8D8' }}>Updated daily with fresh deals • Prices verified within 24 hours</p>
            </div>
            <Link 
              href="/categories" 
          ...
          {products.length > 0 ? (
            ...
            <div className="text-center py-20">
              ...
              <h3 className="text-2xl font-bold mb-4" style={{ color: '#E8F4FD' }}>No deals available yet</h3>
              <p style={{ color: '#B8D4E8' }}>We're curating the best verified deals. Check back soon for amazing offers!</p>
            </div>
          )}
        </div>
      </section>
      ...
      <section className="py-16 px-4" style={{ background: '#0B1E30', borderTop: '1px solid rgba(0,212,200,0.1)' }}>
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4" style={{ color: '#E8F4FD' }}>Why Trust FomoGeo Deals?</h2>
            <p className="text-sm max-w-2xl mx-auto" style={{ color: '#B8D4E6' }}>We don't just aggregate deals — we curate them with expertise and care</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              { icon: '✓', title: 'Hand-Verified', text: 'Every deal checked by our team for quality and value', color: '#00D4C8' },
              { icon: '📊', title: 'Price Tracking', text: 'We monitor price history to ensure genuine savings', color: '#FFB300' },
              { icon: '⭐', title: 'Quality First', text: 'Minimum 4-star ratings from verified customers', color: '#00C853' },
              { icon: '🔄', title: 'Daily Updates', text: 'Fresh deals added and expired ones removed daily', color: '#FF6B00' },
            ].map(({ icon, title, text, color }) => (
              <div key={title} className="text-center p-6 rounded-lg" style={{ background: 'rgba(13,40,64,0.4)', border: `1px solid ${color}20` }}>
      ...
      <section className="py-16 px-4" style={{ background: 'linear-gradient(135deg, #0A1929 0%, #071828 100%)' }}>
        <div className="container mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: '#E8F4FD' }}>Never Miss a Deal</h2>
          <p className="text-lg mb-8 max-w-2xl mx-auto" style={{ color: '#B8D4E8' }}>Subscribe to our newsletter and get exclusive deals delivered to your inbox</p>
          <Link href="/#email-signup" className="inline-block px-8 py-4 rounded-lg font-bold text-lg transition-all hover:scale-105" style={{ background: 'linear-gradient(135deg, #FFB300, #FF8F00)', color: '#fff', boxShadow: '0 4px 15px rgba(255,179,0,0.3)' }}>
            Subscribe Now
          </Link>
        </div>
      </section>
